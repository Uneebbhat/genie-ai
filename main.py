...
def show_settings():
    ...
    ctk.CTkButton(settings_frame, text="🚪 Logout", command=show_login, width=300, fg_color="red").pack(pady=10)
    ctk.CTkButton(settings_frame, text="🔙 Back to Chat", command=show_chat, width=300).pack(pady=10)
...
def show_chat():
    ...
    ctk.CTkButton(input_frame, text="👤 Profile", command=show_settings, width=100, height=45,
